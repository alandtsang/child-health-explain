...
const COLLECTIONS = ['users','children','exams','reports','media_assets','followups','self_checks','notifications','doctor_whitelist','bind_invites','doctor_applications','video_library']
